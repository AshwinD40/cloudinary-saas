  ...
  return (
    ...
    >
        <figure className=' aspect-video relative'>
            ...
            <div className=' absolute bottom-2 right-2 bg-base-100 bg-opacity-70 px-2 py-1 rounded-lg flex text-sm items-center'>
        ...
        <div className='card-body p-4'>
            ...
            <div className='grid grid-cols-2 gap-4 text-sm'>
                ...
                <div className='flex items-center'>
                    ...
                    <div>
                        <div className='font-serif'>Compressed</div>
